...
\subsection{\textcolor{teal}{Comercial}: Acta de entrega al cliente}\index{Comercial!Acta de entrega al cliente}
...
\subsection{\textcolor{teal}{Comercial}: Acta de lectura de medidores}\index{Comercial!Acta de lectura de medidores}
\textbf{Definición:} Documento que registra la lectura de medidores (como agua, electricidad, gas) en el momento de la entrega.
\subsection{\textcolor{teal}{Comercial}: Administración de gastos comunes}\index{Comercial!Administración de gastos comunes}
...
\subsection{\textcolor{teal}{Comercial}: Administración de la comunidad}\index{Comercial!Administración de la comunidad}
...
\subsection{\textcolor{teal}{Comercial}: Agencia de marketing}\index{Comercial!Agencia de marketing}
...
\subsection{\textcolor{teal}{Comercial}: Always on (AO)}\index{Comercial!Always on (AO)}
...
\subsection{\textcolor{teal}{Comercial}: Apertura de cuenta corriente y obtención de rol de la comunidad}\index{Comercial!Apertura de cuenta corriente y obtención de rol de la comunidad}
...
\subsection{\textcolor{teal}{Comercial}: Asamblea de Copropietarios}\index{Comercial!Asamblea de Copropietarios}
...
\subsection{\textcolor{teal}{Comercial}: Asignación de roles SCI}\index{Comercial!Asignación de roles SCI}
\textbf{Definición:} Corresponde a la asignación de roles en el sistema SCI de acuerdo al perfil del trabajador.
\subsection{\textcolor{teal}{Comercial}: Backlink (retroenlace)}\index{Comercial!Backlink (retroenlace)}
...
\subsection{\textcolor{teal}{Comercial}: Calidad experiencia en la cotización/compra sala de ventas (cliente incógnito)}\index{Comercial!Calidad experiencia en la cotización/compra sala de ventas (cliente incógnito)}
...
\subsection{\textcolor{teal}{Comercial}: Cambio de administración}\index{Comercial!Cambio de administración}
...
\subsection{\textcolor{teal}{Comercial}: Campaña de marketing}\index{Comercial!Campaña de marketing}
...
\subsection{\textcolor{teal}{Comercial}: Cliente incógnito (mystery shopper)}\index{Comercial!Cliente incógnito (mystery shopper)}
...
\subsection{\textcolor{teal}{Comercial}: Cliente referido}\index{Comercial!Cliente referido}
\textbf{Definición:} Corresponde al cliente que ha comprado una unidad motivado por la recomendación de otro cliente.
\subsection{\textcolor{teal}{Comercial}: Clusterización}\index{Comercial!Clusterización}
...
\subsection{\textcolor{teal}{Comercial}: Cobros anticipados o prorrogas de pagos al cliente}\index{Comercial!Cobros anticipados o prorrogas de pagos al cliente}
...
\subsection{\textcolor{teal}{Comercial}: Comisión vendedores}\index{Comercial!Comisión vendedores}
...
\subsection{\textcolor{teal}{Comercial}: Compraventa, Escritura de Compraventa o Borrador de Escritura}\index{Comercial!Compraventa, Escritura de Compraventa o Borrador de Escritura}
...
\subsection{\textcolor{teal}{Comercial}: Comunicaciones con el cliente - Posventa}\index{Comercial!Comunicaciones con el cliente - Posventa}
...
\subsection{\textcolor{teal}{Comercial}: Comunidad de copropietarios}\index{Comercial!Comunidad de copropietarios}
...
\subsection{\textcolor{teal}{Comercial}: Comunity manager}\index{Comercial!Comunity manager}
...
\subsection{\textcolor{teal}{Comercial}: Configuración comercial SCI}\index{Comercial!Configuración comercial SCI}
...
\subsection{\textcolor{teal}{Comercial}: Costo por adquisición (CPA)}\index{Comercial!Costo por adquisición (CPA)}
...
\subsection{\textcolor{teal}{Comercial}: Creación de proyecto en SCI}\index{Comercial!Creación de proyecto en SCI}
...
\subsection{\textcolor{teal}{Comercial}: Crédito Directo Socovesa (CDS)}\index{Comercial!Crédito Directo Socovesa (CDS)}
...
\subsection{\textcolor{teal}{Comercial}: Datos de análisis de campañas de Google Ads}\index{Comercial!Datos de análisis de campañas de Google Ads}
...
\subsection{\textcolor{teal}{Comercial}: Datos de análisis de redes sociales}\index{Comercial!Datos de análisis de redes sociales}
...
\subsection{\textcolor{teal}{Comercial}: Datos de análisis de SEO}\index{Comercial!Datos de análisis de SEO}
...
\subsection{\textcolor{teal}{Comercial}: Datos de contacto del cotizante}\index{Comercial!Datos de contacto del cotizante}
...
\subsection{\textcolor{teal}{Comercial}: Datos de cotizantes (Enlace inmobiliario)}\index{Comercial!Datos de cotizantes (Enlace inmobiliario)}
...
\subsection{\textcolor{teal}{Comercial}: Datos de cotizantes (leads de Meta)}\index{Comercial!Datos de cotizantes (leads de Meta)}
\textbf{Definición:} Corresponde al conjunto de datos que identifican y permiten establecer una comunicación con el cotizante, y es obtenida a través del portal inmobiliario "Enlace inmobiliario". Estos datos son los siguientes: nombre cliente, apellido cliente, RUT, correo electrónico y teléfono.
...
\subsection{\textcolor{teal}{Comercial}: Datos de cotizantes (sitio web)}\index{Comercial!Datos de cotizantes (sitio web)}
...
\subsection{\textcolor{teal}{Comercial}: Datos de identificación del cotizante}\index{Comercial!Datos de identificación del cotizante}
...
\subsection{\textcolor{teal}{Comercial}: Datos del cotizantes (Portal Inmobiliario)}\index{Comercial!Datos del cotizantes (Portal Inmobiliario)}
...
\subsection{\textcolor{teal}{Comercial}: Datos del referido (sitio web)}\index{Comercial!Datos del referido (sitio web)}
...
\subsection{\textcolor{teal}{Comercial}: Desistimiento reserva de inmueble}\index{Comercial!Desistimiento reserva de inmueble}
...
\subsection{\textcolor{teal}{Comercial}: Elección de la primera administración}\index{Comercial!Elección de la primera administración}
...
\subsection{\textcolor{teal}{Comercial}: Encuesta calidad de servicio de la entrega}\index{Comercial!Encuesta calidad de servicio de la entrega}
...
\subsection{\textcolor{teal}{Comercial}: Encuesta calidad de servicio de la espera}\index{Comercial!Encuesta calidad de servicio de la espera}
...
\subsection{\textcolor{teal}{Comercial}: Encuesta de calidad de servicio de la posventa}\index{Comercial!Encuesta de calidad de servicio de la posventa}
...
\subsection{\textcolor{teal}{Comercial}: Encuesta de evaluación de campañas de marcas}\index{Comercial!Encuesta de evaluación de campañas de marcas}
...
\subsection{\textcolor{teal}{Comercial}: Encuesta desempeño de producto}\index{Comercial!Encuesta desempeño de producto}
...
\subsection{\textcolor{teal}{Comercial}: Encuesta Perfil de cotizantes y preferencia de clientes}\index{Comercial!Encuesta Perfil de cotizantes y preferencia de clientes}
...
\subsection{\textcolor{teal}{Comercial}: Encuesta Radiografía del Comprador}\index{Comercial!Encuesta Radiografía del Comprador}
...
\subsection{\textcolor{teal}{Comercial}: Entrega de la comunidad a los propietarios}\index{Comercial!Entrega de la comunidad a los propietarios}
...
\subsection{\textcolor{teal}{Comercial}: Estatus de entrega de la propiedad}\index{Comercial!Estatus de entrega de la propiedad}
...
\subsection{\textcolor{teal}{Comercial}: Estudio de cliente incógnito}\index{Comercial!Estudio de cliente incógnito}
...
\subsection{\textcolor{teal}{Comercial}: Estudio de no compra}\index{Comercial!Estudio de no compra}
...
\subsection{\textcolor{teal}{Comercial}: Estudio de valor corporativo}\index{Comercial!Estudio de valor corporativo}
...
\subsection{\textcolor{teal}{Comercial}: Estudio de valor de proyectos}\index{Comercial!Estudio de valor de proyectos}
...
\subsection{\textcolor{teal}{Comercial}: Estudio e imagen de marca}\index{Comercial!Estudio e imagen de marca}
...
\subsection{\textcolor{teal}{Comercial}: Estudio etnográfico (entrevista insight)}\index{Comercial!Estudio etnográfico (entrevista insight)}
...
\subsection{\textcolor{teal}{Comercial}: Estudio etnográfico (entrevista insitu)}\index{Comercial!Estudio etnográfico (entrevista insitu)}
...
\subsection{\textcolor{teal}{Comercial}: Evaluación del cliente - atributos, imagen y evaluación de marca}\index{Comercial!Evaluación del cliente - atributos, imagen y evaluación de marca}
...
\subsection{\textcolor{teal}{Comercial}: Evaluación del cliente - venta de valor corporativo}\index{Comercial!Evaluación del cliente - venta de valor corporativo}
...
\subsection{\textcolor{teal}{Comercial}: Evaluación del cliente - venta de valor proyecto}\index{Comercial!Evaluación del cliente - venta de valor proyecto}
...
\subsection{\textcolor{teal}{Comercial}: Evaluación en público objetivo de la campaña, imagen proyectada, nivel de alcance y retención}\index{Comercial!Evaluación en público objetivo de la campaña, imagen proyectada, nivel de alcance y retención}
...
\subsection{\textcolor{teal}{Comercial}: Experiencia clientes calidad de servicio en la entrega de la vivienda}\index{Comercial!Experiencia clientes calidad de servicio en la entrega de la vivienda}
...
\subsection{\textcolor{teal}{Comercial}: Experiencia clientes calidad de servicio en la espera de la vivienda}\index{Comercial!Experiencia clientes calidad de servicio en la espera de la vivienda}
...
\subsection{\textcolor{teal}{Comercial}: Experiencia clientes calidad de servicio en la posventa de la vivienda}\index{Comercial!Experiencia clientes calidad de servicio en la posventa de la vivienda}
...
\subsection{\textcolor{teal}{Comercial}: Fallas en la revisión calidad/obra de la unidad}\index{Comercial!Fallas en la revisión calidad/obra de la unidad}
...
\subsection{\textcolor{teal}{Comercial}: Fecha estimada de entrega al cliente}\index{Comercial!Fecha estimada de entrega al cliente}
\textbf{Definición:} Fecha prevista para la entrega de la unidad inmobiliaria al cliente.
\subsection{\textcolor{teal}{Comercial}: Feedback del Cliente - Posventa}\index{Comercial!Feedback del Cliente - Posventa}
...
\subsection{\textcolor{teal}{Comercial}: Flujo de cotizantes}\index{Comercial!Flujo de cotizantes}
\textbf{Definición:} Corresponde a la cantidad de cotizantes que tienes en una cantidad de tiempo.
\subsection{\textcolor{teal}{Comercial}: Folleto (Brochure)}\index{Comercial!Folleto (Brochure)}
...
\subsection{\textcolor{teal}{Comercial}: Fondos de reserva comunidad}\index{Comercial!Fondos de reserva comunidad}
...
\subsection{\textcolor{teal}{Comercial}: Funnel de ventas}\index{Comercial!Funnel de ventas}
...
\subsection{\textcolor{teal}{Comercial}: Garantías de posventa}\index{Comercial!Garantías de posventa}
...
\subsection{\textcolor{teal}{Comercial}: Google Addwords}\index{Comercial!Google Addwords}
...
\subsection{\textcolor{teal}{Comercial}: Indicadores de campañas de marketing}\index{Comercial!Indicadores de campañas de marketing}
...
\subsection{\textcolor{teal}{Comercial}: Información del cliente Posventa}\index{Comercial!Información del cliente Posventa}
...
\subsection{\textcolor{teal}{Comercial}: Información etnográfica de cotizantes y compradores (inside)}\index{Comercial!Información etnográfica de cotizantes y compradores (inside)}
...
\subsection{\textcolor{teal}{Comercial}: Información etnográfica de residentes (insitu)}\index{Comercial!Información etnográfica de residentes (insitu)}
...
\subsection{\textcolor{teal}{Comercial}: Intención de búsqueda (keywords - kws)}\index{Comercial!Intención de búsqueda (keywords - kws)}
...
\subsection{\textcolor{teal}{Comercial}: Journey Builder}\index{Comercial!Journey Builder}
...
\subsection{\textcolor{teal}{Comercial}: Leads}\index{Comercial!Leads}
...
\subsection{\textcolor{teal}{Comercial}: Linkbuilding (construcción de enlaces)}\index{Comercial!Linkbuilding (construcción de enlaces)}
...
\subsection{\textcolor{teal}{Comercial}: Llamado de coordinación}\index{Comercial!Llamado de coordinación}
\textbf{Definición:} Comunicación para coordinar acciones o resolver aspectos específicos relacionados con la entrega.
\subsection{\textcolor{teal}{Comercial}: Marketing orgánico}\index{Comercial!Marketing orgánico}
...
\subsection{\textcolor{teal}{Comercial}: Mensajes de Mailing masivo}\index{Comercial!Mensajes de Mailing masivo}
...
\subsection{\textcolor{teal}{Comercial}: Mensajes de SMS masivo}\index{Comercial!Mensajes de SMS masivo}
...
\subsection{\textcolor{teal}{Comercial}: Mensajes de Whatsapp masivo}\index{Comercial!Mensajes de Whatsapp masivo}
...
\subsection{\textcolor{teal}{Comercial}: Modificaciones promesa de compraventa}\index{Comercial!Modificaciones promesa de compraventa}
...
\subsection{\textcolor{teal}{Comercial}: Motivos de no compra}\index{Comercial!Motivos de no compra}
...
\subsection{\textcolor{teal}{Comercial}: Nivel de recomendación o Net Promoter Score (NPS)}\index{Comercial!Nivel de recomendación o Net Promoter Score (NPS)}
...
\subsection{\textcolor{teal}{Comercial}: Nota revisión de calidad a la constructora}\index{Comercial!Nota revisión de calidad a la constructora}
...
\subsection{\textcolor{teal}{Comercial}: Nutrición de leads (Lead nurturing)}\index{Comercial!Nutrición de leads (Lead nurturing)}
...
\subsection{\textcolor{teal}{Comercial}: Observaciones durante la entrega al cliente}\index{Comercial!Observaciones durante la entrega al cliente}
...
\subsection{\textcolor{teal}{Comercial}: Órdenes de compra de marketing}\index{Comercial!Órdenes de compra de marketing}
...
\subsection{\textcolor{teal}{Comercial}: Ordenes de trabajo para reparaciones y mantenimientos - Posventa}\index{Comercial!Ordenes de trabajo para reparaciones y mantenimientos - Posventa}
...
\subsection{\textcolor{teal}{Comercial}: Pedido de materiales - Posventa}\index{Comercial!Pedido de materiales - Posventa}
...
\subsection{\textcolor{teal}{Comercial}: Perfil de cliente}\index{Comercial!Perfil de cliente}
...
\subsection{\textcolor{teal}{Comercial}: Perfilamiento de clientes}\index{Comercial!Perfilamiento de clientes}
...
\subsection{\textcolor{teal}{Comercial}: Piezas de marketing digital}\index{Comercial!Piezas de marketing digital}
...
\subsection{\textcolor{teal}{Comercial}: Planilla de entregas}\index{Comercial!Planilla de entregas}
...
\subsection{\textcolor{teal}{Comercial}: Póliza de seguro venta en verde}\index{Comercial!Póliza de seguro venta en verde}
...
\subsection{\textcolor{teal}{Comercial}: Portal de información inmobiliaria}\index{Comercial!Portal de información inmobiliaria}
...
\subsection{\textcolor{teal}{Comercial}: Posventa}\index{Comercial!Posventa}
...
\subsection{\textcolor{teal}{Comercial}: Pre reserva de inmueble}\index{Comercial!Pre reserva de inmueble}
...
\subsection{\textcolor{teal}{Comercial}: Preferencias de los cotizantes (propios y del mercado)}\index{Comercial!Preferencias de los cotizantes (propios y del mercado)}
...
\subsection{\textcolor{teal}{Comercial}: Proceso de licitación de administraciones}\index{Comercial!Proceso de licitación de administraciones}
...
\subsection{\textcolor{teal}{Comercial}: Promesa de Compraventa}\index{Comercial!Promesa de Compraventa}
...
\subsection{\textcolor{teal}{Comercial}: Promociones y acuerdos comerciales al cliente }\index{Comercial!Promociones y acuerdos comerciales al cliente }
...
\subsection{\textcolor{teal}{Comercial}: Propiedad en parte de pago}\index{Comercial!Propiedad en parte de pago}
...
\subsection{\textcolor{teal}{Comercial}: Proyectos con unidades por entregar}\index{Comercial!Proyectos con unidades por entregar}
...
\subsection{\textcolor{teal}{Comercial}: Recaudación de saldos reales por diferencia de UF}\index{Comercial!Recaudación de saldos reales por diferencia de UF}
...
\subsection{\textcolor{teal}{Comercial}: Recuperación de subsidios y ahorro}\index{Comercial!Recuperación de subsidios y ahorro}
...
\subsection{\textcolor{teal}{Comercial}: Remarketing}\index{Comercial!Remarketing}
...
\subsection{\textcolor{teal}{Comercial}: Render}\index{Comercial!Render}
...
\subsection{\textcolor{teal}{Comercial}: Resciliación de promesa compraventa}\index{Comercial!Resciliación de promesa compraventa}
...
\subsection{\textcolor{teal}{Comercial}: Reserva de inmueble}\index{Comercial!Reserva de inmueble}
...
\subsection{\textcolor{teal}{Comercial}: Retargeting}\index{Comercial!Retargeting}
...
\subsection{\textcolor{teal}{Comercial}: Revisiones de calidad/ obra de la unidad}\index{Comercial!Revisiones de calidad/ obra de la unidad}
...
\subsection{\textcolor{teal}{Comercial}: Satisfacción del cliente desempeño del producto (vivienda)}\index{Comercial!Satisfacción del cliente desempeño del producto (vivienda)}
...
\subsection{\textcolor{teal}{Comercial}: Search Engine Marketing (SEM)}\index{Comercial!Search Engine Marketing (SEM)}
...
\subsection{\textcolor{teal}{Comercial}: Search Engine Optimization (SEO)}\index{Comercial!Search Engine Optimization (SEO)}
...
\subsection{\textcolor{teal}{Comercial}: Segmentación de mercado}\index{Comercial!Segmentación de mercado}
...
\subsection{\textcolor{teal}{Comercial}: Seguimiento de escrituración posfirma}\index{Comercial!Seguimiento de escrituración posfirma}
...
\subsection{\textcolor{teal}{Comercial}: Seguimiento de escrituración pre-firma}\index{Comercial!Seguimiento de escrituración pre-firma}
...
\subsection{\textcolor{teal}{Comercial}: Servicio al cliente (SAC)}\index{Comercial!Servicio al cliente (SAC)}
...
\subsection{\textcolor{teal}{Comercial}: Sitio web}\index{Comercial!Sitio web}
...
\subsection{\textcolor{teal}{Comercial}: Social adds}\index{Comercial!Social adds}
\textbf{Definición:} Publicidad en redes sociales
\subsection{\textcolor{teal}{Comercial}: Solicitudes de posventa}\index{Comercial!Solicitudes de posventa}
...
\subsection{\textcolor{teal}{Comercial}: Stock de material - Posventa}\index{Comercial!Stock de material - Posventa}
...
\subsection{\textcolor{teal}{Comercial}: Tasa de apertura}\index{Comercial!Tasa de apertura}
\textbf{Definición:} Tasa porcentual de personas que abren un email, respecto de los emails enviados que se enviaron.
\subsection{\textcolor{teal}{Comercial}: Tasa de conversión}\index{Comercial!Tasa de conversión}
...
\subsection{\textcolor{teal}{Comercial}: Tasa de rebote}\index{Comercial!Tasa de rebote}
...
\subsection{\textcolor{teal}{Comercial}: Tipos de falla - Árbol de fallas}\index{Comercial!Tipos de falla - Árbol de fallas}
...
\subsection{\textcolor{teal}{Comercial}: Tráfico web}\index{Comercial!Tráfico web}
...
\subsection{\textcolor{teal}{Comercial}: Unidades entregadas}\index{Comercial!Unidades entregadas}
...
\subsection{\textcolor{teal}{Comercial}: Visto bueno de entrega al cliente}\index{Comercial!Visto bueno de entrega al cliente}
...
\subsection{\textcolor{teal}{Construcción}: Análisis físico financiero (AFF)}\index{Construcción!Análisis físico financiero (AFF)}
...
\subsection{\textcolor{teal}{Construcción}: Análisis precio unitario (APU)}\index{Construcción!Análisis precio unitario (APU)}
\textbf{Definición:} Corresponde al presupuesto detallado por partida (ítem único).
\subsection{\textcolor{teal}{Construcción}: Anexo proveedores}\index{Construcción!Anexo proveedores}
...
\subsection{\textcolor{teal}{Construcción}: Arriendo de equipos y maquinarias I-Construye}\index{Construcción!Arriendo de equipos y maquinarias I-Construye}
...
\subsection{\textcolor{teal}{Construcción}: Avance estados de pago obra}\index{Construcción!Avance estados de pago obra}
...
\subsection{\textcolor{teal}{Construcción}: Avance físico de obra}\index{Construcción!Avance físico de obra}
...
\subsection{\textcolor{teal}{Construcción}: Benchmark obra gruesa}\index{Construcción!Benchmark obra gruesa}
...
\subsection{\textcolor{teal}{Construcción}: Benchmark terminaciones}\index{Construcción!Benchmark terminaciones}
...
\subsection{\textcolor{teal}{Construcción}: Carátula de pago}\index{Construcción!Carátula de pago}
...
\subsection{\textcolor{teal}{Construcción}: Centros de gestión IConstruye}\index{Construcción!Centros de gestión IConstruye}
...
\subsection{\textcolor{teal}{Construcción}: Código de producto iConstruye}\index{Construcción!Código de producto iConstruye}
...
\subsection{\textcolor{teal}{Construcción}: Convenios con proveedores}\index{Construcción!Convenios con proveedores}
\textbf{Definición:} Corresponde al listado de productos en convenio con cada proveedor en cada zona y en cada empresa.
\subsection{\textcolor{teal}{Construcción}: Costo contable proyecto}\index{Construcción!Costo contable proyecto}
...
\subsection{\textcolor{teal}{Construcción}: Cotizaciones de materiales}\index{Construcción!Cotizaciones de materiales}
...
\subsection{\textcolor{teal}{Construcción}: Cuadro de cotizaciones subcontratos}\index{Construcción!Cuadro de cotizaciones subcontratos}
...
\subsection{\textcolor{teal}{Construcción}: Cubicación}\index{Construcción!Cubicación}
...
\subsection{\textcolor{teal}{Construcción}: Cubicación de fierro}\index{Construcción!Cubicación de fierro}
\textbf{Definición:} Corresponde al volumen en kilogramos de fierro por cierta superficie en metros cuadrados de un proyecto.
\subsection{\textcolor{teal}{Construcción}: Cubicación de moldaje}\index{Construcción!Cubicación de moldaje}
...
\subsection{\textcolor{teal}{Construcción}: Cubicaciones de hormigón}\index{Construcción!Cubicaciones de hormigón}
...
\subsection{\textcolor{teal}{Construcción}: Cubicaciones de terminaciones}\index{Construcción!Cubicaciones de terminaciones}
...
\subsection{\textcolor{teal}{Construcción}: Datos de identificación de proveedores}\index{Construcción!Datos de identificación de proveedores}
...
\subsection{\textcolor{teal}{Construcción}: Datos planos de respaldo de cubicaciones}\index{Construcción!Datos planos de respaldo de cubicaciones}
...
\subsection{\textcolor{teal}{Construcción}: Desviación del ritmo de actividades}\index{Construcción!Desviación del ritmo de actividades}
...
\subsection{\textcolor{teal}{Construcción}: Elementos de imputación}\index{Construcción!Elementos de imputación}
...
\subsection{\textcolor{teal}{Construcción}: Estados de pago}\index{Construcción!Estados de pago}
...
\subsection{\textcolor{teal}{Construcción}: Evaluaciones de subcontratistas}\index{Construcción!Evaluaciones de subcontratistas}
...
\subsection{\textcolor{teal}{Construcción}: Factura}\index{Construcción!Factura}
...
\subsection{\textcolor{teal}{Construcción}: Gastos del proyecto}\index{Construcción!Gastos del proyecto}
...
\subsection{\textcolor{teal}{Construcción}: Gastos generales (GG)}\index{Construcción!Gastos generales (GG)}
...
\subsection{\textcolor{teal}{Construcción}: Gastos-ingresos departamentos internos constructora}\index{Construcción!Gastos-ingresos departamentos internos constructora}
...
\subsection{\textcolor{teal}{Construcción}: Gestión de bodegas I-Construye}\index{Construcción!Gestión de bodegas I-Construye}
...
\subsection{\textcolor{teal}{Construcción}: Guía de despacho}\index{Construcción!Guía de despacho}
\textbf{Definición:} Documento con el que se hacen las recepciones de productos o servicios. 
\subsection{\textcolor{teal}{Construcción}: Hombre día (HD)}\index{Construcción!Hombre día (HD)}
\textbf{Definición:} Indica cuántos trabajadores realizan una determinada actividad por día de trabajo.
\subsection{\textcolor{teal}{Construcción}: Indicador de terminalidad}\index{Construcción!Indicador de terminalidad}
...
\subsection{\textcolor{teal}{Construcción}: Indicador PSC}\index{Construcción!Indicador PSC}
\textbf{Definición:} Con información de la mutual se genera este indicador psicosocial de los trabajadores.
\subsection{\textcolor{teal}{Construcción}: Indicador seguridad y salud ocupacional (SSO)}\index{Construcción!Indicador seguridad y salud ocupacional (SSO)}
...
\subsection{\textcolor{teal}{Construcción}: Indicador uso de tecnología obra}\index{Construcción!Indicador uso de tecnología obra}
...
\subsection{\textcolor{teal}{Construcción}: Indicadores de gestión documental I-Construye}\index{Construcción!Indicadores de gestión documental I-Construye}
...
\subsection{\textcolor{teal}{Construcción}: Índice remoción de restricciones}\index{Construcción!Índice remoción de restricciones}
\textbf{Definición:} Indica cuantas restricciones se levantaron en un periodo en una obra.
\subsection{\textcolor{teal}{Construcción}: Informe variación de proyecciones de costos}\index{Construcción!Informe variación de proyecciones de costos}
...
\subsection{\textcolor{teal}{Construcción}: Inventario}\index{Construcción!Inventario}
...
\subsection{\textcolor{teal}{Construcción}: Línea de balance de gastos generales (LOB GG)}\index{Construcción!Línea de balance de gastos generales (LOB GG)}
...
\subsection{\textcolor{teal}{Construcción}: Línea de balance oficial (LOB)}\index{Construcción!Línea de balance oficial (LOB)}
...
\subsection{\textcolor{teal}{Construcción}: Maestro de recursos - Arquitectura (IConstruye)}\index{Construcción!Maestro de recursos - Arquitectura (IConstruye)}
...
\subsection{\textcolor{teal}{Construcción}: Maestro de recursos - Desarrollo (IConstruye)}\index{Construcción!Maestro de recursos - Desarrollo (IConstruye)}
...
\subsection{\textcolor{teal}{Construcción}: Maestro de recursos - Gastos de Administración y Ventas (IConstruye)}\index{Construcción!Maestro de recursos - Gastos de Administración y Ventas (IConstruye)}
...
\subsection{\textcolor{teal}{Construcción}: Maestro de recursos - Maestro de materiales (MM)}\index{Construcción!Maestro de recursos - Maestro de materiales (MM)}
...
\subsection{\textcolor{teal}{Construcción}: Maestro de recursos - Marketing (IConstruye)}\index{Construcción!Maestro de recursos - Marketing (IConstruye)}
...
\subsection{\textcolor{teal}{Construcción}: Maestro de recursos - Sala de ventas (IConstruye)}\index{Construcción!Maestro de recursos - Sala de ventas (IConstruye)}
...
\subsection{\textcolor{teal}{Construcción}: Mano de obra directa (M.O.D.)}\index{Construcción!Mano de obra directa (M.O.D.)}
...
\subsection{\textcolor{teal}{Construcción}: Mano de obra subcontratada (M.O.S.)}\index{Construcción!Mano de obra subcontratada (M.O.S.)}
\textbf{Definición:} Corresponde al valor presupuestado total de la mano de obra que se subcontrata por proyecto.
\subsection{\textcolor{teal}{Construcción}: Matriz de terminalidad de actividades}\index{Construcción!Matriz de terminalidad de actividades}
...
\subsection{\textcolor{teal}{Construcción}: Nómina de pagos}\index{Construcción!Nómina de pagos}
...
\subsection{\textcolor{teal}{Construcción}: Notas genéricas al presupuesto}\index{Construcción!Notas genéricas al presupuesto}
...
\subsection{\textcolor{teal}{Construcción}: Notas técnicas al presupuesto}\index{Construcción!Notas técnicas al presupuesto}
...
\subsection{\textcolor{teal}{Construcción}: Obra gruesa (OG)}\index{Construcción!Obra gruesa (OG)}
...
\subsection{\textcolor{teal}{Construcción}: Oficina de partes (electrónica)}\index{Construcción!Oficina de partes (electrónica)}
...
\subsection{\textcolor{teal}{Construcción}: Órdenes de compra}\index{Construcción!Órdenes de compra}
\textbf{Definición:} Documento que refleja un acuerdo comercial entre dos partes emitido por el comprador al proveedor.
\subsection{\textcolor{teal}{Construcción}: Parámetro de costo mano de obra UF/M2 total}\index{Construcción!Parámetro de costo mano de obra UF/M2 total}
\textbf{Definición:} Costo total de proyecto en UF que corresponde a mano de obra.
\subsection{\textcolor{teal}{Construcción}: Parámetro de costo UF/HD}\index{Construcción!Parámetro de costo UF/HD}
\textbf{Definición:} Costo total del proyecto en UF por Hombre día (HD)
\subsection{\textcolor{teal}{Construcción}: Parámetro de costo UF/M2 Edificio}\index{Construcción!Parámetro de costo UF/M2 Edificio}
\textbf{Definición:} Costo del proyecto total en UF por metro cuadrado edificio
\subsection{\textcolor{teal}{Construcción}: Parámetro de costo UF/M2 total}\index{Construcción!Parámetro de costo UF/M2 total}
\textbf{Definición:} Costo del proyecto total en UF por metro cuadrado total
\subsection{\textcolor{teal}{Construcción}: Parámetro de costo UF/M2 Util}\index{Construcción!Parámetro de costo UF/M2 Util}
\textbf{Definición:} Costo del proyecto total en UF por metro cuadrado útil.
\subsection{\textcolor{teal}{Construcción}: Parámetro de rendimiento HD/M2 Total}\index{Construcción!Parámetro de rendimiento HD/M2 Total}
\textbf{Definición:} Costo total de proyecto en Hombre día (HD) que corresponde a mano de obra.
\subsection{\textcolor{teal}{Construcción}: Parámetros mano de obra}\index{Construcción!Parámetros mano de obra}
...
\subsection{\textcolor{teal}{Construcción}: Pedidos de materiales I-Construye}\index{Construcción!Pedidos de materiales I-Construye}
...
\subsection{\textcolor{teal}{Construcción}: Perfiles IConstruye}\index{Construcción!Perfiles IConstruye}
...
\subsection{\textcolor{teal}{Construcción}: Planificación de control de producción (PCP)}\index{Construcción!Planificación de control de producción (PCP)}
...
\subsection{\textcolor{teal}{Construcción}: Planificación intermedia de obra}\index{Construcción!Planificación intermedia de obra}
...
\subsection{\textcolor{teal}{Construcción}: Planificación semanal de obra}\index{Construcción!Planificación semanal de obra}
...
\subsection{\textcolor{teal}{Construcción}: Plazos avanzados/proyectados por actividad/obra}\index{Construcción!Plazos avanzados/proyectados por actividad/obra}
\textbf{Definición:} Control de avance de obras no rítmicas de proyecto (por ejemplo, fachadas y exteriores).
\subsection{\textcolor{teal}{Construcción}: Plazos oficiales obra gruesa}\index{Construcción!Plazos oficiales obra gruesa}
...
\subsection{\textcolor{teal}{Construcción}: Plazos oficiales terminaciones}\index{Construcción!Plazos oficiales terminaciones}
...
\subsection{\textcolor{teal}{Construcción}: Plazos preliminares obra gruesa}\index{Construcción!Plazos preliminares obra gruesa}
...
\subsection{\textcolor{teal}{Construcción}: Plazos preliminares terminaciones}\index{Construcción!Plazos preliminares terminaciones}
...
\subsection{\textcolor{teal}{Construcción}: Presupuesto}\index{Construcción!Presupuesto}
\textbf{Definición:} Cálculo anticipado del costo de una obra o un servicio.
\subsection{\textcolor{teal}{Construcción}: Presupuesto entibaciones}\index{Construcción!Presupuesto entibaciones}
...
\subsection{\textcolor{teal}{Construcción}: Presupuesto inmobiliaria}\index{Construcción!Presupuesto inmobiliaria}
\textbf{Definición:} Corresponde al costo presupuestado en UF para el proyecto más la utilidad de la inmobiliaria
\subsection{\textcolor{teal}{Construcción}: Presupuesto obra}\index{Construcción!Presupuesto obra}
\textbf{Definición:} Corresponde al costo presupuestado en UF para el proyecto
\subsection{\textcolor{teal}{Construcción}: Presupuesto obra gruesa}\index{Construcción!Presupuesto obra gruesa}
\textbf{Definición:} Cálculo anticipado del costo de la obra gruesa de un proyecto (enfierradora, moldajes, hormigón, etc.)
\subsection{\textcolor{teal}{Construcción}: Presupuesto obras extras}\index{Construcción!Presupuesto obras extras}
...
\subsection{\textcolor{teal}{Construcción}: Presupuesto obras preliminares}\index{Construcción!Presupuesto obras preliminares}
...
\subsection{\textcolor{teal}{Construcción}: Presupuesto terminaciones}\index{Construcción!Presupuesto terminaciones}
\textbf{Definición:} Cálculo anticipado de costo de las terminaciones de las obras.
\subsection{\textcolor{teal}{Construcción}: Proveedores integrados a I-Construye}\index{Construcción!Proveedores integrados a I-Construye}
...
\subsection{\textcolor{teal}{Construcción}: Proyección de costos por familia}\index{Construcción!Proyección de costos por familia}
...
\subsection{\textcolor{teal}{Construcción}: Proyección de termino de actividad/obra}\index{Construcción!Proyección de termino de actividad/obra}
...
\subsection{\textcolor{teal}{Construcción}: Recepción de materiales}\index{Construcción!Recepción de materiales}
\textbf{Definición:} Es un documento asociado a la orden de compra que indica esta última se hace efectiva.
\subsection{\textcolor{teal}{Construcción}: Rendimiento de actividades críticas (m2/hd)}\index{Construcción!Rendimiento de actividades críticas (m2/hd)}
...
\subsection{\textcolor{teal}{Construcción}: Rendimiento mano de obra por especialidad (obra gruesa y terminaciones)}\index{Construcción!Rendimiento mano de obra por especialidad (obra gruesa y terminaciones)}
...
\subsection{\textcolor{teal}{Construcción}: Rendimiento obra gruesa (m2/hd)}\index{Construcción!Rendimiento obra gruesa (m2/hd)}
\textbf{Definición:} Indicador metro cuadrado por hombre día en actividades de obra gruesa (por ejemplo, moldaje)
\subsection{\textcolor{teal}{Construcción}: Reportes I-Construye}\index{Construcción!Reportes I-Construye}
...
\subsection{\textcolor{teal}{Construcción}: Resultados mano de obra}\index{Construcción!Resultados mano de obra}
...
\subsection{\textcolor{teal}{Construcción}: Retenciones provisionadas por obra}\index{Construcción!Retenciones provisionadas por obra}
\textbf{Definición:} Cuanto es lo que tiene cada obra en retención de devoluciones.
\subsection{\textcolor{teal}{Construcción}: Ritmo de avance de obra}\index{Construcción!Ritmo de avance de obra}
\textbf{Definición:} Casa/departamentos semanales. En caso de obra gruesa de edificios, pisos mensuales.
\subsection{\textcolor{teal}{Construcción}: Roles IConstruye}\index{Construcción!Roles IConstruye}
...
\subsection{\textcolor{teal}{Construcción}: Subcontrato proveedores}\index{Construcción!Subcontrato proveedores}
...
\subsection{\textcolor{teal}{Construcción}: Terminaciones y revestimientos}\index{Construcción!Terminaciones y revestimientos}
...
\subsection{\textcolor{teal}{Construcción}: Usuarios IConstruye}\index{Construcción!Usuarios IConstruye}
...
\subsection{\textcolor{teal}{Construcción}: Valor ganado obra}\index{Construcción!Valor ganado obra}
...
\subsection{\textcolor{teal}{Construcción}: Valor proforma (VPF)}\index{Construcción!Valor proforma (VPF)}
...
\subsection{\textcolor{teal}{Contabilidad}: Flujo de aprobación - Rindegastos}\index{Contabilidad!Flujo de aprobación - Rindegastos}
...
\subsection{\textcolor{teal}{Contabilidad}: Fondo fijo - Rindegasto}\index{Contabilidad!Fondo fijo - Rindegasto}
...
\subsection{\textcolor{teal}{Contabilidad}: Informe de gastos - Rindegastos}\index{Contabilidad!Informe de gastos - Rindegastos}
...
\subsection{\textcolor{teal}{Contabilidad}: Política de gastos - Rindegastos}\index{Contabilidad!Política de gastos - Rindegastos}
...
\subsection{\textcolor{teal}{Contabilidad}: Rendidores - Rindegastos}\index{Contabilidad!Rendidores - Rindegastos}
...
\subsection{\textcolor{teal}{Contabilidad}: UF}\index{Contabilidad!UF}
...
\subsection{\textcolor{teal}{Finanzas}: AFR}\index{Finanzas!AFR}
...
\subsection{\textcolor{teal}{Finanzas}: Amortización a Deuda}\index{Finanzas!Amortización a Deuda}
...
\subsection{\textcolor{teal}{Finanzas}: Aprobación Bancaria}\index{Finanzas!Aprobación Bancaria}
...
\subsection{\textcolor{teal}{Finanzas}: Banco Alzante}\index{Finanzas!Banco Alzante}
...
\subsection{\textcolor{teal}{Finanzas}: BCU/BCP}\index{Finanzas!BCU/BCP}
...
\subsection{\textcolor{teal}{Finanzas}: Boleta de Garantía}\index{Finanzas!Boleta de Garantía}
...
\subsection{\textcolor{teal}{Finanzas}: Boleta de garantía pagadera a 30 días}\index{Finanzas!Boleta de garantía pagadera a 30 días}
...
\subsection{\textcolor{teal}{Finanzas}: Boleta de garantía pagadera a la vista}\index{Finanzas!Boleta de garantía pagadera a la vista}
\textbf{Definición:} Boleta de garantía que es pagada al momento de ser presentada físicamente en el banco donde fue emitida.
\subsection{\textcolor{teal}{Finanzas}: Borrador}\index{Finanzas!Borrador}
\textbf{Definición:} ver Compraventa
\subsection{\textcolor{teal}{Finanzas}: Cambio Oferente}\index{Finanzas!Cambio Oferente}
\textbf{Definición:} Cambio de titular de promesa de compraventa.
\subsection{\textcolor{teal}{Finanzas}: Carta de crédito}\index{Finanzas!Carta de crédito}
...
\subsection{\textcolor{teal}{Finanzas}: Carta de resguardo}\index{Finanzas!Carta de resguardo}
...
\subsection{\textcolor{teal}{Finanzas}: Carta Pie}\index{Finanzas!Carta Pie}
...
\subsection{\textcolor{teal}{Finanzas}: Carta Resguardo}\index{Finanzas!Carta Resguardo}
...
\subsection{\textcolor{teal}{Finanzas}: Cesión de derechos}\index{Finanzas!Cesión de derechos}
...
\subsection{\textcolor{teal}{Finanzas}: Cierre de Condiciones}\index{Finanzas!Cierre de Condiciones}
...
\subsection{\textcolor{teal}{Finanzas}: Codeudor}\index{Finanzas!Codeudor}
...
\subsection{\textcolor{teal}{Finanzas}: Compañía de Seguros}\index{Finanzas!Compañía de Seguros}
...
\subsection{\textcolor{teal}{Finanzas}: Compensación}\index{Finanzas!Compensación}
...
\subsection{\textcolor{teal}{Finanzas}: Conservador de Bienes y Raíces o CBR}\index{Finanzas!Conservador de Bienes y Raíces o CBR}
...
\subsection{\textcolor{teal}{Finanzas}: Copia Maestra}\index{Finanzas!Copia Maestra}
\textbf{Definición:} Copia de la compraventa con al menos la firma de una de las partes.
\subsection{\textcolor{teal}{Finanzas}: Copropiedad}\index{Finanzas!Copropiedad}
\textbf{Definición:} Reglamento, Planos, Certificado
\subsection{\textcolor{teal}{Finanzas}: Corredor de Seguros}\index{Finanzas!Corredor de Seguros}
...
\subsection{\textcolor{teal}{Finanzas}: Costear/ Cerrar un proyecto}\index{Finanzas!Costear/ Cerrar un proyecto}
\textbf{Definición:} Asignar costo a las unidades de los proyectos terminados.
\subsection{\textcolor{teal}{Finanzas}: Cotitular}\index{Finanzas!Cotitular}
...
\subsection{\textcolor{teal}{Finanzas}: Crédito Hipotecario}\index{Finanzas!Crédito Hipotecario}
...
\subsection{\textcolor{teal}{Finanzas}: Curse}\index{Finanzas!Curse}
...
\subsection{\textcolor{teal}{Finanzas}: Declaración Personal de Salud o DPS}\index{Finanzas!Declaración Personal de Salud o DPS}
...
\subsection{\textcolor{teal}{Finanzas}: Depósito a Plazo}\index{Finanzas!Depósito a Plazo}
...
\subsection{\textcolor{teal}{Finanzas}: Desistimiento}\index{Finanzas!Desistimiento}
...
\subsection{\textcolor{teal}{Finanzas}: Desistimiento de cobro}\index{Finanzas!Desistimiento de cobro}
...
\subsection{\textcolor{teal}{Finanzas}: Escritura de Alzamiento}\index{Finanzas!Escritura de Alzamiento}
\textbf{Definición:} Documento que comprueba que el inmueble o terreno se encuentra libre de cualquier deuda u obligación.
\subsection{\textcolor{teal}{Finanzas}: Estado Resultados  EERR}\index{Finanzas!Estado Resultados  EERR}
\textbf{Definición:} resultado de negocios en un plazo determinado
\subsection{\textcolor{teal}{Finanzas}: Estudio de títulos}\index{Finanzas!Estudio de títulos}
...
\subsection{\textcolor{teal}{Finanzas}: Flujo de aprobación (Rindegastos)}\index{Finanzas!Flujo de aprobación (Rindegastos)}
\textbf{Definición:} Está definido a partir de una política y tiene relación con la aprobación (usuarios aprobadores) del gasto a quienes rinden (usuarios rendidores).
\subsection{\textcolor{teal}{Finanzas}: Flujo Largo de Caja}\index{Finanzas!Flujo Largo de Caja}
\textbf{Definición:} Corresponde al Saldo de Caja proyectado a dos o tres años.
\subsection{\textcolor{teal}{Finanzas}: Fondos fijos (Rindegastos)}\index{Finanzas!Fondos fijos (Rindegastos)}
\textbf{Definición:} Corresponde a la cantidad de dinero asignada a un usuario por concepto de caja chica, para solventar gastos necesarios del área. El fondo fijo a cada usuario está reflejado en SAP.
\subsection{\textcolor{teal}{Finanzas}: Fondos Mutuos}\index{Finanzas!Fondos Mutuos}
...
\subsection{\textcolor{teal}{Finanzas}: Forward}\index{Finanzas!Forward}
\textbf{Definición:} instrumento financiero utilizado para fijar el tipo de cambio futuro.
\subsection{\textcolor{teal}{Finanzas}: Glosa boleta garantía}\index{Finanzas!Glosa boleta garantía}
\textbf{Definición:} Es donde se debe señalar la caución (motivo) para lo cual se está solicitando la boleta de garantía.
\subsection{\textcolor{teal}{Finanzas}: GP}\index{Finanzas!GP}
...
\subsection{\textcolor{teal}{Finanzas}: Hipoteca}\index{Finanzas!Hipoteca}
\textbf{Definición:} Garantía que se deja a una institución financiera para asegurar el cumplimiento de una obligación.
\subsection{\textcolor{teal}{Finanzas}: IMACEC}\index{Finanzas!IMACEC}
...
\subsection{\textcolor{teal}{Finanzas}: Índices Inmobiliarios}\index{Finanzas!Índices Inmobiliarios}
...
\subsection{\textcolor{teal}{Finanzas}: Inflación}\index{Finanzas!Inflación}
...
\subsection{\textcolor{teal}{Finanzas}: Informe de gastos (Rindegastos)}\index{Finanzas!Informe de gastos (Rindegastos)}
...
\subsection{\textcolor{teal}{Finanzas}: Instrucciones Notariales}\index{Finanzas!Instrucciones Notariales}
...
\subsection{\textcolor{teal}{Finanzas}: Lanzamiento}\index{Finanzas!Lanzamiento}
\textbf{Definición:} Hito en el que un proyecto comienza la venta.
\subsection{\textcolor{teal}{Finanzas}: Leasing habitacional}\index{Finanzas!Leasing habitacional}
...
\subsection{\textcolor{teal}{Finanzas}: Leasing operativo}\index{Finanzas!Leasing operativo}
...
\subsection{\textcolor{teal}{Finanzas}: Liquidación de crédito}\index{Finanzas!Liquidación de crédito}
...
\subsection{\textcolor{teal}{Finanzas}: Liquidador de Seguros}\index{Finanzas!Liquidador de Seguros}
...
\subsection{\textcolor{teal}{Finanzas}: Márgenes Promesados}\index{Finanzas!Márgenes Promesados}
...
\subsection{\textcolor{teal}{Finanzas}: Novación}\index{Finanzas!Novación}
...
\subsection{\textcolor{teal}{Finanzas}: Pactos Financieros}\index{Finanzas!Pactos Financieros}
...
\subsection{\textcolor{teal}{Finanzas}: Pagaré}\index{Finanzas!Pagaré}
...
\subsection{\textcolor{teal}{Finanzas}: PIB}\index{Finanzas!PIB}
...
\subsection{\textcolor{teal}{Finanzas}: Política de gastos (Rindegastos)}\index{Finanzas!Política de gastos (Rindegastos)}
\textbf{Definición:} Cada política de gastos tiene configuraciones propias asociadas a código, cuenta, elementos de imputación, tipos de documentos, usuarios, etc.; y corresponde al punto de acceso para que uno o varios usuarios puedan rendir los gastos en una determinada área.
\subsection{\textcolor{teal}{Finanzas}: Póliza de Seguro}\index{Finanzas!Póliza de Seguro}
...
\subsection{\textcolor{teal}{Finanzas}: Póliza de Urbanización}\index{Finanzas!Póliza de Urbanización}
...
\subsection{\textcolor{teal}{Finanzas}: Post Venta}\index{Finanzas!Post Venta}
...
\subsection{\textcolor{teal}{Finanzas}: Preaprobación bancaria}\index{Finanzas!Preaprobación bancaria}
...
\subsection{\textcolor{teal}{Finanzas}: Real Proyectado (RP)}\index{Finanzas!Real Proyectado (RP)}
...
\subsection{\textcolor{teal}{Finanzas}: Recepción Municipal (RM)}\index{Finanzas!Recepción Municipal (RM)}
\textbf{Definición:} Es el trámite mediante el cual se recibe una obra de construcción con el fin de autorizar su uso.
\subsection{\textcolor{teal}{Finanzas}: Redenominación}\index{Finanzas!Redenominación}
\textbf{Definición:} Es cuando un crédito cambia de moneda pasando por ejemplo de UF a pesos.
\subsection{\textcolor{teal}{Finanzas}: Rendidores (Rindegastos)}\index{Finanzas!Rendidores (Rindegastos)}
\textbf{Definición:} Usuario que tiene un fondo fijo asignado y que por tal monto debe rendir lo gastado. (puede rendir hasta el monto asignado)
\subsection{\textcolor{teal}{Finanzas}: Renovación}\index{Finanzas!Renovación}
...
\subsection{\textcolor{teal}{Finanzas}: Reparos}\index{Finanzas!Reparos}
\textbf{Definición:} Antecedentes pendientes en un estudio de títulos.
\subsection{\textcolor{teal}{Finanzas}: Saldo Caja}\index{Finanzas!Saldo Caja}
...
\subsection{\textcolor{teal}{Finanzas}: Seguro de AP}\index{Finanzas!Seguro de AP}
...
\subsection{\textcolor{teal}{Finanzas}: Seguro de Equipos Móviles}\index{Finanzas!Seguro de Equipos Móviles}
\textbf{Definición:} Póliza que cubre todos los riesgos de un equipo móvil (tractor, bobcat, grúa, grupo electrógeno, etc).
\subsection{\textcolor{teal}{Finanzas}: Seguro de garantía de Venta en Verde}\index{Finanzas!Seguro de garantía de Venta en Verde}
...
\subsection{\textcolor{teal}{Finanzas}: Seguro de Incendio}\index{Finanzas!Seguro de Incendio}
\textbf{Definición:} Esta póliza cubre todos los riesgos de un proyecto (o bien raíz) terminado (después de la RM).
\subsection{\textcolor{teal}{Finanzas}: Seguro de RC}\index{Finanzas!Seguro de RC}
...
\subsection{\textcolor{teal}{Finanzas}: Seguro desgravamen}\index{Finanzas!Seguro desgravamen}
...
\subsection{\textcolor{teal}{Finanzas}: Seguro TRC}\index{Finanzas!Seguro TRC}
...
\subsection{\textcolor{teal}{Finanzas}: Titular}\index{Finanzas!Titular}
\textbf{Definición:} sujeto que puede ejercer, promover y exigir un derecho hipotecario
\subsection{\textcolor{teal}{Finanzas}: TPM}\index{Finanzas!TPM}
...
\subsection{\textcolor{teal}{Finanzas}: Vale vista}\index{Finanzas!Vale vista}
...
\subsection{\textcolor{teal}{Finanzas}: Vencimiento de Intereses}\index{Finanzas!Vencimiento de Intereses}
...
\subsection{\textcolor{teal}{Finanzas}: Visado}\index{Finanzas!Visado}
...
\subsection{\textcolor{teal}{Gobierno de Datos}: Administración de Bases de Datos (Database Management)}\index{Gobierno de Datos!Administración de Bases de Datos (Database Management)}
...
\subsection{\textcolor{teal}{Gobierno de Datos}: Almacén de Datos (Data Warehouse)}\index{Gobierno de Datos!Almacén de Datos (Data Warehouse)}
...
\subsection{\textcolor{teal}{Gobierno de Datos}: Almacenamiento de Datos (Data Storage)}\index{Gobierno de Datos!Almacenamiento de Datos (Data Storage)}
\textbf{Definición:} Conjunto de especificaciones que sirven para definir cómo, cuándo y qué información se almacena.
\subsection{\textcolor{teal}{Gobierno de Datos}: Aprendizaje Automático (Machine Learning)}\index{Gobierno de Datos!Aprendizaje Automático (Machine Learning)}
...
\subsection{\textcolor{teal}{Gobierno de Datos}: Aprendizaje Profundo (Deep Learning)}\index{Gobierno de Datos!Aprendizaje Profundo (Deep Learning)}
...
\subsection{\textcolor{teal}{Gobierno de Datos}: Arquitectura de Datos (Data Architecture)}\index{Gobierno de Datos!Arquitectura de Datos (Data Architecture)}
...
\subsection{\textcolor{teal}{Gobierno de Datos}: Base de Datos (Database)}\index{Gobierno de Datos!Base de Datos (Database)}
...
\subsection{\textcolor{teal}{Gobierno de Datos}: Calidad del Dato (Data quality)}\index{Gobierno de Datos!Calidad del Dato (Data quality)}
...
\subsection{\textcolor{teal}{Gobierno de Datos}: Catalogación de Datos (Data Cataloging)}\index{Gobierno de Datos!Catalogación de Datos (Data Cataloging)}
...
\subsection{\textcolor{teal}{Gobierno de Datos}: Ciencia de Datos (Data Science)}\index{Gobierno de Datos!Ciencia de Datos (Data Science)}
...
\subsection{\textcolor{teal}{Gobierno de Datos}: COBIT}\index{Gobierno de Datos!COBIT}
...
\subsection{\textcolor{teal}{Gobierno de Datos}: Custodio de Datos (Data Steward)}\index{Gobierno de Datos!Custodio de Datos (Data Steward)}
...
\subsection{\textcolor{teal}{Gobierno de Datos}: Custodio Técnico de Datos (Technical Data Steward)}\index{Gobierno de Datos!Custodio Técnico de Datos (Technical Data Steward)}
...
\subsection{\textcolor{teal}{Gobierno de Datos}: DAMA (Data Managment Association)}\index{Gobierno de Datos!DAMA (Data Managment Association)}
...
\subsection{\textcolor{teal}{Gobierno de Datos}: Dato (Data)}\index{Gobierno de Datos!Dato (Data)}
...
\subsection{\textcolor{teal}{Gobierno de Datos}: Dato Personal}\index{Gobierno de Datos!Dato Personal}
...
\subsection{\textcolor{teal}{Gobierno de Datos}: Datos masivos/ Macrodatos (Big Data)}\index{Gobierno de Datos!Datos masivos/ Macrodatos (Big Data)}
...
\subsection{\textcolor{teal}{Gobierno de Datos}: Datos personales sensibles}\index{Gobierno de Datos!Datos personales sensibles}
...
\subsection{\textcolor{teal}{Gobierno de Datos}: Derecho de acceso (Ley de datos personales)}\index{Gobierno de Datos!Derecho de acceso (Ley de datos personales)}
...
\subsection{\textcolor{teal}{Gobierno de Datos}: Derecho de cancelación (Ley de datos personales)}\index{Gobierno de Datos!Derecho de cancelación (Ley de datos personales)}
...
\subsection{\textcolor{teal}{Gobierno de Datos}: Derecho de oposición (Ley de datos personales)}\index{Gobierno de Datos!Derecho de oposición (Ley de datos personales)}
...
\subsection{\textcolor{teal}{Gobierno de Datos}: Derecho de portabilidad de los datos personales (Ley de datos personales)}\index{Gobierno de Datos!Derecho de portabilidad de los datos personales (Ley de datos personales)}
...
\subsection{\textcolor{teal}{Gobierno de Datos}: Derecho de rectificación (Ley de datos personales)}\index{Gobierno de Datos!Derecho de rectificación (Ley de datos personales)}
...
\subsection{\textcolor{teal}{Gobierno de Datos}: Derechos ARCO (Ley de datos personales)}\index{Gobierno de Datos!Derechos ARCO (Ley de datos personales)}
...
\subsection{\textcolor{teal}{Gobierno de Datos}: Dueño de Datos (Data Owner)}\index{Gobierno de Datos!Dueño de Datos (Data Owner)}
\textbf{Definición:} El último responsable de la información asociada los datos.
\subsection{\textcolor{teal}{Gobierno de Datos}: Encriptación de Datos (Data encryption)}\index{Gobierno de Datos!Encriptación de Datos (Data encryption)}
...
\subsection{\textcolor{teal}{Gobierno de Datos}: Enmascaramiento de Datos (Data Masking)}\index{Gobierno de Datos!Enmascaramiento de Datos (Data Masking)}
...
\subsection{\textcolor{teal}{Gobierno de Datos}: Escape de Datos (Data Breach)}\index{Gobierno de Datos!Escape de Datos (Data Breach)}
...
\subsection{\textcolor{teal}{Gobierno de Datos}: ETL (Extract, transform and load)}\index{Gobierno de Datos!ETL (Extract, transform and load)}
...
\subsection{\textcolor{teal}{Gobierno de Datos}: Fuentes de acceso público}\index{Gobierno de Datos!Fuentes de acceso público}
...
\subsection{\textcolor{teal}{Gobierno de Datos}: Gestión de Datos (Data Management)}\index{Gobierno de Datos!Gestión de Datos (Data Management)}
...
\subsection{\textcolor{teal}{Gobierno de Datos}: Gestión de Metadatos (Metadata Management)}\index{Gobierno de Datos!Gestión de Metadatos (Metadata Management)}
...
\subsection{\textcolor{teal}{Gobierno de Datos}: Gobernanza de Datos (Data Governance)}\index{Gobierno de Datos!Gobernanza de Datos (Data Governance)}
...
\subsection{\textcolor{teal}{Gobierno de Datos}: Hurto/Robo de Datos (Data Theft)}\index{Gobierno de Datos!Hurto/Robo de Datos (Data Theft)}
...
\subsection{\textcolor{teal}{Gobierno de Datos}: Información Sensible (Sensitive Information)}\index{Gobierno de Datos!Información Sensible (Sensitive Information)}
...
\subsection{\textcolor{teal}{Gobierno de Datos}: Integración de Datos (Data Integration)}\index{Gobierno de Datos!Integración de Datos (Data Integration)}
...
\subsection{\textcolor{teal}{Gobierno de Datos}: Inteligencia Artificial (Artificial Intelligence)}\index{Gobierno de Datos!Inteligencia Artificial (Artificial Intelligence)}
...
\subsection{\textcolor{teal}{Gobierno de Datos}: Inteligencia de Negocios (Business Intelligence) }\index{Gobierno de Datos!Inteligencia de Negocios (Business Intelligence) }
...
\subsection{\textcolor{teal}{Gobierno de Datos}: Lago de Datos (Data Lake)}\index{Gobierno de Datos!Lago de Datos (Data Lake)}
...
\subsection{\textcolor{teal}{Gobierno de Datos}: Limpieza de Datos (Data Cleansing)}\index{Gobierno de Datos!Limpieza de Datos (Data Cleansing)}
...
\subsection{\textcolor{teal}{Gobierno de Datos}: Linaje del Dato (Data Lineage) }\index{Gobierno de Datos!Linaje del Dato (Data Lineage) }
...
\subsection{\textcolor{teal}{Gobierno de Datos}: Mapeo de Datos (Data Mapping)}\index{Gobierno de Datos!Mapeo de Datos (Data Mapping)}
...
\subsection{\textcolor{teal}{Gobierno de Datos}: Metadato (Metadata)}\index{Gobierno de Datos!Metadato (Metadata)}
...
\subsection{\textcolor{teal}{Gobierno de Datos}: Migración de Datos (Data Migration)}\index{Gobierno de Datos!Migración de Datos (Data Migration)}
...
\subsection{\textcolor{teal}{Gobierno de Datos}: Minería de datos (Data Mining)}\index{Gobierno de Datos!Minería de datos (Data Mining)}
...
\subsection{\textcolor{teal}{Gobierno de Datos}: Modelado de Datos (Data Modeling)}\index{Gobierno de Datos!Modelado de Datos (Data Modeling)}
...
\subsection{\textcolor{teal}{Gobierno de Datos}: NoSQL}\index{Gobierno de Datos!NoSQL}
...
\subsection{\textcolor{teal}{Gobierno de Datos}: Nube (Cloud)}\index{Gobierno de Datos!Nube (Cloud)}
...
\subsection{\textcolor{teal}{Gobierno de Datos}: Paisaje de Datos (Data Landscape)}\index{Gobierno de Datos!Paisaje de Datos (Data Landscape)}
...
\subsection{\textcolor{teal}{Gobierno de Datos}: Perfilamiento de Datos (Data Profiling)}\index{Gobierno de Datos!Perfilamiento de Datos (Data Profiling)}
...
\subsection{\textcolor{teal}{Gobierno de Datos}: Política de Datos (Data Policy)}\index{Gobierno de Datos!Política de Datos (Data Policy)}
...
\subsection{\textcolor{teal}{Gobierno de Datos}: Proceso de anonimización o disociación}\index{Gobierno de Datos!Proceso de anonimización o disociación}
...
\subsection{\textcolor{teal}{Gobierno de Datos}: Reconocimiento / Conciencia de los Datos (Data awareness)}\index{Gobierno de Datos!Reconocimiento / Conciencia de los Datos (Data awareness)}
...
\subsection{\textcolor{teal}{Gobierno de Datos}: Repositorio de Datos (Data Repository)}\index{Gobierno de Datos!Repositorio de Datos (Data Repository)}
\textbf{Definición:} Base de datos, aplicación u otra ubicación donde los datos son almacenados electrónicamente.
\subsection{\textcolor{teal}{Gobierno de Datos}: Respaldo de Seguridad (Backup)}\index{Gobierno de Datos!Respaldo de Seguridad (Backup)}
...
\subsection{\textcolor{teal}{Gobierno de Datos}: Seguridad de Datos (Data Security)}\index{Gobierno de Datos!Seguridad de Datos (Data Security)}
...
\subsection{\textcolor{teal}{Gobierno de Datos}: Silo de Datos (Data Silo)}\index{Gobierno de Datos!Silo de Datos (Data Silo)}
...
\subsection{\textcolor{teal}{Gobierno de Datos}: Sistema de Gestión de Bases de Datos (Database Management System o DBMS)}\index{Gobierno de Datos!Sistema de Gestión de Bases de Datos (Database Management System o DBMS)}
...
\subsection{\textcolor{teal}{Gobierno de Datos}: SQL}\index{Gobierno de Datos!SQL}
...
\subsection{\textcolor{teal}{Gobierno de Datos}: Titular de datos o titular}\index{Gobierno de Datos!Titular de datos o titular}
\textbf{Definición:} Persona natural, identificada o identificable, a quien conciernen o se refieren los datos personales. 
\subsection{\textcolor{teal}{Gobierno de Datos}: Transmisión de Datos (Data Streaming)}\index{Gobierno de Datos!Transmisión de Datos (Data Streaming)}
...
\subsection{\textcolor{teal}{Gobierno de Datos}: Tratamiento de datos}\index{Gobierno de Datos!Tratamiento de datos}
...
\subsection{\textcolor{teal}{Inmobiliaria}: Arquitecto CABIDA proyecto}\index{Inmobiliaria!Arquitecto CABIDA proyecto}
\textbf{Definición:} Corresponde al arquitecto asignado para realizar la CABIDA arquitectónica de un proyecto inmobiliario.
\subsection{\textcolor{teal}{Inmobiliaria}: CABIDA}\index{Inmobiliaria!CABIDA}
...
\subsection{\textcolor{teal}{Inmobiliaria}: Carta gantt proyecto}\index{Inmobiliaria!Carta gantt proyecto}
...
\subsection{\textcolor{teal}{Inmobiliaria}: Categoría de proyecto}\index{Inmobiliaria!Categoría de proyecto}
...
\subsection{\textcolor{teal}{Inmobiliaria}: CIP}\index{Inmobiliaria!CIP}
...
\subsection{\textcolor{teal}{Inmobiliaria}: Código PCT/ Carpeta física}\index{Inmobiliaria!Código PCT/ Carpeta física}
...
\subsection{\textcolor{teal}{Inmobiliaria}: Datos del mercado inmobiliario}\index{Inmobiliaria!Datos del mercado inmobiliario}
...
\subsection{\textcolor{teal}{Inmobiliaria}: Datos del proyecto}\index{Inmobiliaria!Datos del proyecto}
...
\subsection{\textcolor{teal}{Inmobiliaria}: Datos del terreno}\index{Inmobiliaria!Datos del terreno}
...
\subsection{\textcolor{teal}{Inmobiliaria}: Datos descripción del proyecto}\index{Inmobiliaria!Datos descripción del proyecto}
...
\subsection{\textcolor{teal}{Inmobiliaria}: Datos Financieros del Proyecto}\index{Inmobiliaria!Datos Financieros del Proyecto}
...
\subsection{\textcolor{teal}{Inmobiliaria}: EECC}\index{Inmobiliaria!EECC}
\textbf{Definición:} Espacios Comunes
\subsection{\textcolor{teal}{Inmobiliaria}: Estado proyecto}\index{Inmobiliaria!Estado proyecto}
...
\subsection{\textcolor{teal}{Inmobiliaria}: Metraje departamento}\index{Inmobiliaria!Metraje departamento}
...
\subsection{\textcolor{teal}{Inmobiliaria}: Mix departamento}\index{Inmobiliaria!Mix departamento}
...
\subsection{\textcolor{teal}{Inmobiliaria}: ODI}\index{Inmobiliaria!ODI}
\textbf{Definición:} Oficina Diseño de Interiores
\subsection{\textcolor{teal}{Inmobiliaria}: Plancheta}\index{Inmobiliaria!Plancheta}
...
\subsection{\textcolor{teal}{Inmobiliaria}: Proyecto inmobiliario}\index{Inmobiliaria!Proyecto inmobiliario}
...
\subsection{\textcolor{teal}{Inmobiliaria}: Temblor}\index{Inmobiliaria!Temblor}
\textbf{Definición:} Resumen financiero proyecto
\subsection{\textcolor{teal}{Inmobiliaria}: Temblor compra}\index{Inmobiliaria!Temblor compra}
\textbf{Definición:} Análisis financiero del proyecto al momento de la compra del terreno.
\subsection{\textcolor{teal}{Inmobiliaria}: Temblor lanzamiento}\index{Inmobiliaria!Temblor lanzamiento}
\textbf{Definición:} Análisis financiero del proyecto al momento de empezar la venta de los proyectos.
\subsection{\textcolor{teal}{Inmobiliaria}: Temblor piso tipo}\index{Inmobiliaria!Temblor piso tipo}
...
\subsection{\textcolor{teal}{Inmobiliaria}: Tipología Departamento}\index{Inmobiliaria!Tipología Departamento}
...
\subsection{\textcolor{teal}{Inmobiliaria}: Unidades departamento}\index{Inmobiliaria!Unidades departamento}
...
\subsection{\textcolor{teal}{Lean}:  5 por qué}\index{Lean! 5 por qué}
...
\subsection{\textcolor{teal}{Lean}: Panel de Control}\index{Lean!Panel de Control}
...
\subsection{\textcolor{teal}{Lean}: SIPOC}\index{Lean!SIPOC}
...
\subsection{\textcolor{teal}{Lean}: Sistema 5S}\index{Lean!Sistema 5S}
...
\subsection{\textcolor{teal}{Lean}: Takt Time}\index{Lean!Takt Time}
...
\subsection{\textcolor{teal}{Lean}: Value Stream Mapping (VSM) / Mapeo del flujo de valor}\index{Lean!Value Stream Mapping (VSM) / Mapeo del flujo de valor}
...
\subsection{\textcolor{teal}{RRHH}: Administración de la Compensación}\index{RRHH!Administración de la Compensación}
...
\subsection{\textcolor{teal}{RRHH}: Anexo de Contrato}\index{RRHH!Anexo de Contrato}
...
\subsection{\textcolor{teal}{RRHH}: Área}\index{RRHH!Área}
...
\subsection{\textcolor{teal}{RRHH}: Asignaciones}\index{RRHH!Asignaciones}
...
\subsection{\textcolor{teal}{RRHH}: Ausentismo}\index{RRHH!Ausentismo}
\textbf{Definición:} Inasistencia por causas justificadas o injustificadas al trabajo de un empleado.
\subsection{\textcolor{teal}{RRHH}: Autoevaluación de Desempeño}\index{RRHH!Autoevaluación de Desempeño}
...
\subsection{\textcolor{teal}{RRHH}: Base de datos personales}\index{RRHH!Base de datos personales}
...
\subsection{\textcolor{teal}{RRHH}: Bono}\index{RRHH!Bono}
...
\subsection{\textcolor{teal}{RRHH}: Calculadora de Cargo}\index{RRHH!Calculadora de Cargo}
\textbf{Definición:} Permite definir en nivel de presencialidad del cargo en base a una serie de parámetros. 
\subsection{\textcolor{teal}{RRHH}: Capacitación laboral}\index{RRHH!Capacitación laboral}
...
\subsection{\textcolor{teal}{RRHH}: Cargo}\index{RRHH!Cargo}
\textbf{Definición:} Objeto único asociado con la información de la posición.
\subsection{\textcolor{teal}{RRHH}: Cargo operativo obra}\index{RRHH!Cargo operativo obra}
...
\subsection{\textcolor{teal}{RRHH}: Cargo sujeto a evaluación de desempeño}\index{RRHH!Cargo sujeto a evaluación de desempeño}
...
\subsection{\textcolor{teal}{RRHH}: Carta oferta laboral}\index{RRHH!Carta oferta laboral}
...
\subsection{\textcolor{teal}{RRHH}: Clima Organizacional}\index{RRHH!Clima Organizacional}
\textbf{Definición:} Conjunto de las sensaciones e impresiones de los colaboradores de una empresa sobre el ambiente laboral.
\subsection{\textcolor{teal}{RRHH}: Comisiones}\index{RRHH!Comisiones}
\textbf{Definición:} Parte de la remuneración variable por concepto de ventas.
\subsection{\textcolor{teal}{RRHH}: Competencia crítica}\index{RRHH!Competencia crítica}
...
\subsection{\textcolor{teal}{RRHH}: Competencia deseable}\index{RRHH!Competencia deseable}
...
\subsection{\textcolor{teal}{RRHH}: Competencias}\index{RRHH!Competencias}
...
\subsection{\textcolor{teal}{RRHH}: Competencias específicas}\index{RRHH!Competencias específicas}
...
\subsection{\textcolor{teal}{RRHH}: Competencias transversales}\index{RRHH!Competencias transversales}
...
\subsection{\textcolor{teal}{RRHH}: Conductas}\index{RRHH!Conductas}
...
\subsection{\textcolor{teal}{RRHH}: Contrato de Trabajo}\index{RRHH!Contrato de Trabajo}
...
\subsection{\textcolor{teal}{RRHH}: Contrato Indefinido}\index{RRHH!Contrato Indefinido}
...
\subsection{\textcolor{teal}{RRHH}: Contrato por Obra o Faena}\index{RRHH!Contrato por Obra o Faena}
...
\subsection{\textcolor{teal}{RRHH}: Curriculum Vitae (CV)}\index{RRHH!Curriculum Vitae (CV)}
...
\subsection{\textcolor{teal}{RRHH}: Datos Académicos}\index{RRHH!Datos Académicos}
...
\subsection{\textcolor{teal}{RRHH}: Datos de contacto del empleado}\index{RRHH!Datos de contacto del empleado}
...
\subsection{\textcolor{teal}{RRHH}: Datos de emergencia del empleado}\index{RRHH!Datos de emergencia del empleado}
...
\subsection{\textcolor{teal}{RRHH}: Datos de identificación del empleado}\index{RRHH!Datos de identificación del empleado}
...
\subsection{\textcolor{teal}{RRHH}: Datos para depósito del empleado}\index{RRHH!Datos para depósito del empleado}
...
\subsection{\textcolor{teal}{RRHH}: Datos previsionales del empleado}\index{RRHH!Datos previsionales del empleado}
...
\subsection{\textcolor{teal}{RRHH}: Datos relación de parentesco familiar dentro de la empresa}\index{RRHH!Datos relación de parentesco familiar dentro de la empresa}
...
\subsection{\textcolor{teal}{RRHH}: Departamento}\index{RRHH!Departamento}
...
\subsection{\textcolor{teal}{RRHH}: Descuentos}\index{RRHH!Descuentos}
...
\subsection{\textcolor{teal}{RRHH}: Desempeño Histórico}\index{RRHH!Desempeño Histórico}
\textbf{Definición:} Corresponde a la evaluación de desempeño histórica de los trabajadores.
\subsection{\textcolor{teal}{RRHH}: Dimensión de la competencia}\index{RRHH!Dimensión de la competencia}
...
\subsection{\textcolor{teal}{RRHH}: Elemento PEP}\index{RRHH!Elemento PEP}
...
\subsection{\textcolor{teal}{RRHH}: Empresa}\index{RRHH!Empresa}
...
\subsection{\textcolor{teal}{RRHH}: Estructura Organizacional}\index{RRHH!Estructura Organizacional}
...
\subsection{\textcolor{teal}{RRHH}: Evaluación de Desempeño}\index{RRHH!Evaluación de Desempeño}
...
\subsection{\textcolor{teal}{RRHH}: Familia de cargo KPI}\index{RRHH!Familia de cargo KPI}
...
\subsection{\textcolor{teal}{RRHH}: Familia de cargo Memoria}\index{RRHH!Familia de cargo Memoria}
...
\subsection{\textcolor{teal}{RRHH}: Feriado legal/ Vacaciones}\index{RRHH!Feriado legal/ Vacaciones}
...
\subsection{\textcolor{teal}{RRHH}: Ficha de Ingreso del Trabajador}\index{RRHH!Ficha de Ingreso del Trabajador}
...
\subsection{\textcolor{teal}{RRHH}: Firma Electrónica}\index{RRHH!Firma Electrónica}
...
\subsection{\textcolor{teal}{RRHH}: Fortaleza (competencias)}\index{RRHH!Fortaleza (competencias)}
...
\subsection{\textcolor{teal}{RRHH}: Fuero maternal}\index{RRHH!Fuero maternal}
...
\subsection{\textcolor{teal}{RRHH}: Gerencia}\index{RRHH!Gerencia}
\textbf{Definición:} Corresponde a la sección de la empresa donde el trabajado se desempeña. Por ejemplo, Gerencia de Sistemas.
\subsection{\textcolor{teal}{RRHH}: Gratificación legal}\index{RRHH!Gratificación legal}
...
\subsection{\textcolor{teal}{RRHH}: Grupo Familiar}\index{RRHH!Grupo Familiar}
\textbf{Definición:} Conjunto de personas unidas o no por vínculos de sangre que dan forma al núcleo familiar.
\subsection{\textcolor{teal}{RRHH}: GX}\index{RRHH!GX}
\textbf{Definición:} Grupo ejecutivo
\subsection{\textcolor{teal}{RRHH}: Haberes}\index{RRHH!Haberes}
...
\subsection{\textcolor{teal}{RRHH}: Habilidades conductuales-relacionales a capacitar (Resultado evaluación de desempeño)}\index{RRHH!Habilidades conductuales-relacionales a capacitar (Resultado evaluación de desempeño)}
...
\subsection{\textcolor{teal}{RRHH}: Habilidades técnicas a capacitar (Resultado evaluación de desempeño)}\index{RRHH!Habilidades técnicas a capacitar (Resultado evaluación de desempeño)}
...
\subsection{\textcolor{teal}{RRHH}: Horas extraordinarias}\index{RRHH!Horas extraordinarias}
...
\subsection{\textcolor{teal}{RRHH}: Indicadores de eficacia capacitación mensual/anual}\index{RRHH!Indicadores de eficacia capacitación mensual/anual}
...
\subsection{\textcolor{teal}{RRHH}: Indicadores económicos capacitación mensual/anual}\index{RRHH!Indicadores económicos capacitación mensual/anual}
...
\subsection{\textcolor{teal}{RRHH}: InfoNómina}\index{RRHH!InfoNómina}
...
\subsection{\textcolor{teal}{RRHH}: Información aula virtual GESOC}\index{RRHH!Información aula virtual GESOC}
...
\subsection{\textcolor{teal}{RRHH}: Información cursos }\index{RRHH!Información cursos }
...
\subsection{\textcolor{teal}{RRHH}: Información laboral}\index{RRHH!Información laboral}
...
\subsection{\textcolor{teal}{RRHH}: Información proveedores de capacitación (OTEC)}\index{RRHH!Información proveedores de capacitación (OTEC)}
...
\subsection{\textcolor{teal}{RRHH}: Jefatura}\index{RRHH!Jefatura}
...
\subsection{\textcolor{teal}{RRHH}: Jefe Evaluador}\index{RRHH!Jefe Evaluador}
\textbf{Definición:} Corresponde a la jefatura que realizará la evaluación de desempeño del trabajador.
\subsection{\textcolor{teal}{RRHH}: Licencia Médica}\index{RRHH!Licencia Médica}
...
\subsection{\textcolor{teal}{RRHH}: Licencia médica postnatal}\index{RRHH!Licencia médica postnatal}
...
\subsection{\textcolor{teal}{RRHH}: Licencia médica prenatal}\index{RRHH!Licencia médica prenatal}
...
\subsection{\textcolor{teal}{RRHH}: Liquidación de Sueldo}\index{RRHH!Liquidación de Sueldo}
...
\subsection{\textcolor{teal}{RRHH}: Marca}\index{RRHH!Marca}
...
\subsection{\textcolor{teal}{RRHH}: Matriz de talento (Nine box)}\index{RRHH!Matriz de talento (Nine box)}
...
\subsection{\textcolor{teal}{RRHH}: Modelo de gestión por competencias}\index{RRHH!Modelo de gestión por competencias}
...
\subsection{\textcolor{teal}{RRHH}: Necesidades de capacitación (Resultado evaluación de desempeño)}\index{RRHH!Necesidades de capacitación (Resultado evaluación de desempeño)}
...
\subsection{\textcolor{teal}{RRHH}: Nivel de conducta}\index{RRHH!Nivel de conducta}
...
\subsection{\textcolor{teal}{RRHH}: Nivel de talento}\index{RRHH!Nivel de talento}
...
\subsection{\textcolor{teal}{RRHH}: Nivel HAY}\index{RRHH!Nivel HAY}
...
\subsection{\textcolor{teal}{RRHH}: Oportunidad de mejora (competencias)}\index{RRHH!Oportunidad de mejora (competencias)}
...
\subsection{\textcolor{teal}{RRHH}: Organigrama}\index{RRHH!Organigrama}
...
\subsection{\textcolor{teal}{RRHH}: Organismo técnico de capacitación (OTEC)}\index{RRHH!Organismo técnico de capacitación (OTEC)}
...
\subsection{\textcolor{teal}{RRHH}: Perfil de cargo}\index{RRHH!Perfil de cargo}
\textbf{Definición:} Corresponde al grupo de cargos con un mismo nivel conductual y para una misma unidad de negocio.
\subsection{\textcolor{teal}{RRHH}: Perfil de línea conductual}\index{RRHH!Perfil de línea conductual}
...
\subsection{\textcolor{teal}{RRHH}: Perfil meta}\index{RRHH!Perfil meta}
...
\subsection{\textcolor{teal}{RRHH}: Persona sujeta a evaluación}\index{RRHH!Persona sujeta a evaluación}
...
\subsection{\textcolor{teal}{RRHH}: Personal activo}\index{RRHH!Personal activo}
\textbf{Definición:} Persona que se encuentra trabajando de forma activa en la empresa.
\subsection{\textcolor{teal}{RRHH}: Personal directivo obra}\index{RRHH!Personal directivo obra}
...
\subsection{\textcolor{teal}{RRHH}: Personal inactivo}\index{RRHH!Personal inactivo}
\textbf{Definición:} Persona que no se encuentra trabajando de forma activa en la empresa. Personas finiquitadas.
\subsection{\textcolor{teal}{RRHH}: Plataforma 5.dec}\index{RRHH!Plataforma 5.dec}
...
\subsection{\textcolor{teal}{RRHH}: Posición}\index{RRHH!Posición}
\textbf{Definición:} Objeto relacionado con la estructura organizacional y asignado a una persona
\subsection{\textcolor{teal}{RRHH}: Puntaje Evaluación de Desempeño}\index{RRHH!Puntaje Evaluación de Desempeño}
...
\subsection{\textcolor{teal}{RRHH}: Puntaje Evaluación de Desempeño Calibrado}\index{RRHH!Puntaje Evaluación de Desempeño Calibrado}
...
\subsection{\textcolor{teal}{RRHH}: Puntaje responsabilidad para el cargo (Metodología HAY)}\index{RRHH!Puntaje responsabilidad para el cargo (Metodología HAY)}
...
\subsection{\textcolor{teal}{RRHH}: Puntaje saber para el cargo (Metodología HAY)}\index{RRHH!Puntaje saber para el cargo (Metodología HAY)}
...
\subsection{\textcolor{teal}{RRHH}: Puntaje solución de problemas para el cargo (Metodología HAY)}\index{RRHH!Puntaje solución de problemas para el cargo (Metodología HAY)}
...
\subsection{\textcolor{teal}{RRHH}: Remuneración}\index{RRHH!Remuneración}
...
\subsection{\textcolor{teal}{RRHH}: Remuneración fija}\index{RRHH!Remuneración fija}
...
\subsection{\textcolor{teal}{RRHH}: Remuneración variable}\index{RRHH!Remuneración variable}
...
\subsection{\textcolor{teal}{RRHH}: Retroalimentación laboral (Feedback)}\index{RRHH!Retroalimentación laboral (Feedback)}
...
\subsection{\textcolor{teal}{RRHH}: Saldos de Vacaciones}\index{RRHH!Saldos de Vacaciones}
...
\subsection{\textcolor{teal}{RRHH}: Sistema Uno}\index{RRHH!Sistema Uno}
...
\subsection{\textcolor{teal}{RRHH}: Solicitudes de formación}\index{RRHH!Solicitudes de formación}
...
\subsection{\textcolor{teal}{RRHH}: Subordinado}\index{RRHH!Subordinado}
...
\subsection{\textcolor{teal}{RRHH}: Sueldo Imponible}\index{RRHH!Sueldo Imponible}
...
\subsection{\textcolor{teal}{RRHH}: Sueldo Líquido}\index{RRHH!Sueldo Líquido}
...
\subsection{\textcolor{teal}{RRHH}: SUMASU}\index{RRHH!SUMASU}
...
\subsection{\textcolor{teal}{RRHH}: Teletrabajo}\index{RRHH!Teletrabajo}
...
\subsection{\textcolor{teal}{RRHH}: Tipo de Contrato}\index{RRHH!Tipo de Contrato}
...
\subsection{\textcolor{teal}{RRHH}: Total Imponible}\index{RRHH!Total Imponible}
...
\subsection{\textcolor{teal}{RRHH}: Total Tributable}\index{RRHH!Total Tributable}
...
\subsection{\textcolor{teal}{RRHH}: UEN}\index{RRHH!UEN}
...
\subsection{\textcolor{teal}{Sistemas TI}: Agile-Agilidad}\index{Sistemas TI!Agile-Agilidad}
...
\subsection{\textcolor{teal}{Sistemas TI}: DevOps}\index{Sistemas TI!DevOps}
