...
$proyectoData = @{
    "Zona" = "Z-AA+CB/CM"
    "Superficie Neta" = 2429.9
    "Superficie Vendible" = 10320.6
    "Unidades" = 236
    "Costo Terreno" = 128880
    "Margen IFRS" = 31.5
    "Ingreso Total" = 625129
    "TIR" = 10.8
    "Inmobiliaria" = "PILARES"
    "Centro Costo" = "2289"
    "RolMatriz" = "479-1"
    "Firma Planos" = "2019-08-28"
    "Permiso Edificacion" = "2020-09-23"
    "Inicio Ventas" = "2021-09-16"
    "Resolucion Recepcion" = "2023-07-26"
    "Entrega Departamentos" = "2023-07-26"
}
$validData = @{}
foreach ($key in $proyectoData.Keys) {
    if (Field-Exists -ListName "Proyecto Inmobiliario" -FieldName $key) {
...
# [El resto del script permanece igual hasta después de añadir los datos a las listas]
